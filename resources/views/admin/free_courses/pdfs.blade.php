                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="la la-file-pdf-o"></i> جميع ملفات البرنامج العلمي للدورة المجانية وعددهم {{ $pdfs->count() }} ملف </h4>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><embed style="width: 200px;height: 150px;" src=" {{ asset('assets/pdfs/admin/free_courses/').'/'.$pdf->pdf }}"></td>
                                                    <td>
                                                        <div class="btn-group" role="group"
                                                             aria-label="Basic example">
                                                            <a href="{{ route('admin.get.pdf.free.courses.edit',$pdf->id) }}"
                                                               class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل</a>
                                                            <a href="{{ route('admin.get.pdf.free.courses.delete',['id'=>$pdf->id,'course_id'=>$pdf->course_id]) }}"
