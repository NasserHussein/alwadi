                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">تعديل بيانات الدورة المجانية
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">تعديل بيانات الدورة المجانية</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form form-prevent-multiple-submits" action="{{ route('admin.free.courses.update',$course->id) }}" method="POST"
                                          enctype="multipart/form-data">
                                          @csrf
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-feather"></i>من فضلك ادخل البيانات الجديدة للدورة المجانية</h4>

                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1">تحديث أسم الدورة المجانية</label>
                                                        <input type="text" value="{{ $course->name }}" id="name"
                                                               class="form-control"
                                                               placeholder=" أدخل أسم الدورة المجانية"
                                                               name="name">
                                                               @error('name')
