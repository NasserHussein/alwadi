                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="la la-comments"></i> أستشارات لم تدفع {{ $consuls->count() }}</h4>
                                ...
                                <div class="card-body card-dashboard">
                                    <table style="text-align: center"
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    <td><div style="word-wrap: break-word;width:30px;">{{ $consul->id }}</div></td>
                                                    <td>@if($consul->pay_state == '1') تم الدفع @else لم يتم الدفع @endif</td>
                                                    <td><div style="word-wrap: break-word;width:90px;">{{ $consul->user_email }}</div></td>
