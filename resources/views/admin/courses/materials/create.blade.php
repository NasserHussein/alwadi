                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form form-prevent-multiple-submits" action="{{ route('admin.store.materials.courses') }}" method="POST"
                                        ...
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="la la-pencil-square-o"></i>أضف محتوي في قسم المادة العلمية</h4>
