<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
  <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="nav-item active"><a href=""><i class="la la-group"></i>
              <span class="menu-title" data-i18n="nav.dash.main">المستخدمين</span>
              <span
                  class="badge badge badge-success badge-pill float-right mr-2">@if(auth()->user()->state == 1){{ App\Models\Client::count() }}@endif</span>
            </a>
              <ul class="menu-content">
                  <li class=""><a class="menu-item" href="{{ route('admin.show.users') }}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                  </li>
              </ul>
          </li>

          <li class="nav-item active"><a href=""><i class="ft-video"></i>
              <span class="menu-title" data-i18n="nav.dash.main">zoom</span>
              <span
                  class="badge badge badge-danger badge-pill float-right mr-2">Zoom</span>
            </a>
              <ul class="menu-content">
                  <li class=""><a class="menu-item" href="{{ route('admin.get.zoom') }}" data-i18n="nav.dash.ecommerce"> عرض التفاصيل </a>
                  </li>
              </ul>
          </li>

          <li class="nav-item active"><a href=""><i class="ficon ft-mail"></i>
            <span class="menu-title" data-i18n="nav.dash.main">رسائل الموقع</span>
            <span
                class="badge badge badge-warning float-right mr-2">{{ App\Models\Contact::count() }}</span>
          </a>
            <ul class="menu-content">
                <li class=""><a class="menu-item" href="{{ route('admin.get.contact') }}" data-i18n="nav.dash.ecommerce"> عرض كل الرسائل </a>
                </li>
            </ul>
        </li>

          <li class="nav-item active"><a href=""><i class="la la-compass"></i>
            <span class="menu-title" data-i18n="nav.dash.main">الأستشارات</span>
            <span
                class="badge badge badge-info badge badge-pill bg-blue-grey float-right mr-2">@if(auth()->user()->state == 1){{ App\Models\Consultation::count() }}@endif</span>
          </a>
            <ul class="menu-content">
                <li class=""><a class="menu-item" href="{{ route('admin.get.consulting.paid') }}" data-i18n="nav.dash.ecommerce">عرض الأستشارات المدفوعة</a>
                </li>
                <li class=""><a class="menu-item" href="{{ route('admin.get.consulting.price') }}" data-i18n="nav.dash.ecommerce">تغيير سعر الأستشارات</a>
                </li>
            </ul>
        </li>

          <li class="nav-item active"><a href=""><i class="ft-hash"></i>
            <span class="menu-title" data-i18n="nav.dash.main">النشرات الاخبارية</span>
            <span
                class="badge badge badge-info badge-pill float-right mr-2">{{ App\Models\Subscribe::count() }}</span>
          </a>
            <ul class="menu-content">
                <li class=""><a class="menu-item" href="{{ route('admin.get.subscribes') }}" data-i18n="nav.dash.ecommerce">عرض كل المشتركين</a>
                </li>
                <li class=""><a class="menu-item" href="{{ route('admin.create.mail.news.subscribes') }}" data-i18n="nav.dash.ecommerce">أرسال نشرة إلي الجميع</a>
                </li>
            </ul>
        </li>

          <li class="nav-item active"><a href=""><i class="la la-user-plus"></i>
              <span class="menu-title" data-i18n="nav.dash.main">الأعضاء المشتركين</span>
              <span
                  class="badge badge badge-danger badge-pill float-right mr-2">@if(auth()->user()->state == 1){{ App\Models\Admin\Auth::count() }}@endif</span>
            </a>
              <ul class="menu-content">
                  <li class=""><a class="menu-item" href="{{ route('admin.get.Auths.courses') }}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                  </li>
              </ul>
              <ul class="menu-content">
                     <li class=""><a class="menu-item" href="{{ route('admin.create.Auths.courses') }}" data-i18n="nav.dash.ecommerce">فتح دورة للمستخدم</a>
                     </li>
                 </ul>
          </li>

          <li class="nav-item active"><a href=""><i class="la la-certificate"></i>
              <span class="menu-title" data-i18n="nav.dash.main">الدورات المميزة</span>
              <span
                  class="badge badge badge-warning  badge-pill float-right mr-2">{{ App\Models\Admin\Course::count() }}</span>
           </a>
              <ul class="menu-content">
                  <li class=""><a class="menu-item" href="{{ route('admin.get.courses') }}"
                                        data-i18n="nav.dash.ecommerce"> عرض جميع الدورات المميزة</a>
                  </li>
                  <li><a class="menu-item" href="{{ route('admin.courses.create') }}" data-i18n="nav.dash.crypto">إضافة دورة جديدة </a>
                  </li>
                  <li class="nav-item"><a href=""><i class="icon-list"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">أقسام الدورة المميزة</span>
                     </a>
                    <ul class="menu-content">

                        <li><a class="menu-item" href="{{ route('admin.create.lessons.courses') }}" data-i18n="nav.dash.crypto">أضافة
                            دروس للدورة</a>
                        </li>
                        <li><a class="menu-item" href="{{ route('admin.create.materials.courses') }}" data-i18n="nav.dash.crypto">أضافة
                           المادة العلمية للدورة</a>
                       </li>
                       <li><a class="menu-item" href="{{ route('admin.create.pdfs.courses') }}" data-i18n="nav.dash.crypto">أضافة
                           البرنامج العملي للدورة</a>
                       </li>
                    </ul>
                  </li>
              </ul>
        ...
        <li class="nav-item active"><a href=""><i class="icon-lock-open"></i>
            <span class="menu-title" data-i18n="nav.dash.main">الدورات المجانية</span>
            <span
                class="badge badge badge-success badge-pill float-right mr-2">{{ App\Models\Admin\FreeCourse::count() }}</span>
             </a>
            <ul class="menu-content">
                <li class=""><a class="menu-item" href="{{ route('admin.get.free.courses') }}"
                                      data-i18n="nav.dash.ecommerce"> عرض جميع الدورات المجانية</a>
                </li>
                <li><a class="menu-item" href="{{ route('admin.free.courses.create') }}" data-i18n="nav.dash.crypto">إضافة دورة مجانية جديدة </a>
                </li>
                <li class="nav-item"><a href=""><i class="icon-list"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">أقسام الدورة المجانية</span>

                     </a>
                    <ul class="menu-content">

                        <li><a class="menu-item" href="{{ route('admin.create.lessons.free.courses') }}" data-i18n="nav.dash.crypto">أضافة
                            دروس للدورة المجانية</a>
                        </li>
                        <li><a class="menu-item" href="{{ route('admin.create.materials.free.courses') }}" data-i18n="nav.dash.crypto">أضافة
                           المادة العلمية للدورة</a>
                       </li>
                       <li><a class="menu-item" href="{{ route('admin.create.pdfs.free.courses') }}" data-i18n="nav.dash.crypto">أضافة
                           البرنامج العملي للدورة</a>
                       </li>
                    </ul>
                </li>
          ...
          <li class="nav-item active"><a href=""><i class="icon-user"></i>
              <span class="menu-title" data-i18n="nav.dash.main">عن محمد فرج</span>
              <span
                  class="badge badge badge-info badge-pill float-right mr-2">{{ App\Models\Admin\CvDetail::count() }}</span>
           </a>
              <ul class="menu-content">

                  <li><a class="menu-item" href="{{ route('admin.get.details.about.owner') }}" data-i18n="nav.dash.crypto">
                     عرض المحتوي</a>
                  </li>
                  <li><a class="menu-item" href="{{ route('admin.create.details.owner') }}" data-i18n="nav.dash.crypto">أضافة
                     محتوي</a>
                 </li>
                  <li><a class="menu-item" href="{{ route('admin.get.photo.details.owner') }}" data-i18n="nav.dash.crypto">تحديث
                     الصورة</a>
                 </li>
              </ul>
          </li>

          <li class="nav-item active"><a href=""><i class="la la-institution"></i>
              <span class="menu-title" data-i18n="nav.dash.main">عن أكاديمية فرج</span>
              <span
                  class="badge badge badge-warning  badge-pill float-right mr-2">{{ App\Models\Admin\AboutAcademy::count() }}</span>
           </a>
              <ul class="menu-content">

                  <li><a class="menu-item" href="{{ route('admin.get.details.about.academy') }}" data-i18n="nav.dash.crypto">
                     عرض المحتوي</a>
                  </li>
                  <li><a class="menu-item" href="{{ route('admin.create.details.academy') }}" data-i18n="nav.dash.crypto">أضافة
                     محتوي</a>
                 </li>
                  <li><a class="menu-item" href="{{ route('admin.get.photo.details.academy') }}" data-i18n="nav.dash.crypto">تحديث
                     الصورة</a>
                 </li>
              </ul>
          </li>

          <li class="nav-item active"><a href=""><i class="la la-question"></i>
            <span class="menu-title" data-i18n="nav.dash.main">الأسئلة الشائعة</span>
            <span
                class="badge badge badge-success badge-pill float-right mr-2">{{ App\Models\Admin\FAQ::count() }}</span>
         </a>
            <ul class="menu-content">

                <li><a class="menu-item" href="{{ route('admin.get.faq') }}" data-i18n="nav.dash.crypto">
                   عرض الأسئلة</a>
                </li>
                <li><a class="menu-item" href="{{ route('admin.create.faq') }}" data-i18n="nav.dash.crypto">أضافة
                   أسئلة</a>
               </li>
                  ...
                  <li class="nav-item active"><a href=""><i class="ft-file-text"></i>
            <span class="menu-title" data-i18n="nav.dash.main">الشروط والأحكام</span>
            <span
                class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\Admin\Terms::count() }}</span>
         </a>
            <ul class="menu-content">

                <li><a class="menu-item" href="{{ route('admin.get.terms') }}" data-i18n="nav.dash.crypto">
                   عرض المحتوي</a>
                </li>
                <li><a class="menu-item" href="{{ route('admin.create.terms') }}" data-i18n="nav.dash.crypto">أضافة
                   محتوي</a>
               </li>

            </ul>
        </li>
                  <li class="nav-item active"><a href=""><i class="icon-shield"></i>
            <span class="menu-title" data-i18n="nav.dash.main">سياسية الخصوصية</span>
            <span
                class="badge badge badge-info badge-pill float-right mr-2">{{ App\Models\Admin\Privacy::count() }}</span>
         </a>
            <ul class="menu-content">

                <li><a class="menu-item" href="{{ route('admin.get.privacy') }}" data-i18n="nav.dash.crypto">
                   عرض المحتوي</a>
                </li>
                <li><a class="menu-item" href="{{ route('admin.create.privacy') }}" data-i18n="nav.dash.crypto">أضافة
                   محتوي</a>
               </li>
