    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">جميع الرسائل </h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">الرئيسية</a>
                            <li class="breadcrumb-item active"> جميع الرسائل
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="ficon ft-mail"></i> جميع الرسائل</h4>
                                    ...
                                    <table style="text-align: center"
                                        ...
                                        <thead>
                                            <div class="row">
                                                ...
                                                <a href="{{ route('admin.get.contact.active') }}"
                                            ...
                                            @foreach ($messages as $message)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($message->state == '2' || $message->state == '1')
