    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">الرسائل المنتهية</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">الرئيسية</a>
                                <li class="breadcrumb-item"><a href="{{ route('admin.get.contact') }}">جميع الرسائل </a>
                            <li class="breadcrumb-item active">  الرسائل المنتهية
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="icon-check"></i> الرسائل المنتهية {{ $messages->count() }}</h4>
